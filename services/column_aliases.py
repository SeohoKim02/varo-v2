...
STORE_ALIASES = {
    ...
    "node_type": ["node_type", "store_type", "type", "유형", "구분", "노드유형", "점포유형"],
...
ROUTE_ALIASES = {
    "source_id": ["source_id", "from_id", "from_store_id", "출발점포id", "출발id", "보내는점포id"],
    "target_id": ["target_id", "to_id", "to_store_id", "도착점포id", "도착id", "받는점포id"],
...
RECOMMENDATION_ALIASES = {
    ...
    "product_id": ["product_id", "item_id", "상품코드", "상품id"],
    "product_name": ["product_name", "item_name", "상품명", "상품", "제품명"],
    "source_id": ["source_id", "source_store_id", "from_store_id", "from_id", "출발점포id", "출발id", "보내는점포id"],
    "source_name": ["source_name", "source_store", "from_store_name", "from_store", "출발점포", "보내는점포"],
    "target_id": ["target_id", "target_store_id", "to_store_id", "to_id", "도착점포id", "도착id", "받는점포id"],
    "target_name": ["target_name", "target_store", "to_store_name", "to_store", "도착점포", "받는점포"],
    "dc_id": ["dc_id", "물류센터id", "dcid", "센터id"],
    "dc_name": ["dc_name", "via_dc_name", "물류센터", "dc", "센터명"],
    "route_type": ["route_type", "경로유형", "경로구분", "유형"],
    "recommended_qty": ["recommended_qty", "suggested_qty", "transfer_qty", "추천수량", "이동수량"],
    "transport_type": ["transport_type", "transport_mode", "이동수단", "운송수단"],
    "estimated_cost": ["estimated_cost", "transport_cost", "cost", "이동비용", "운송비"],
    "expected_saving": ["expected_saving", "expected_savings", "saving_amount", "savings", "예상절감액", "절감액"],
