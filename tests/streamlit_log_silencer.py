...
def quiet_streamlit_test_logs() -> None:
    # Streamlit's AppTest creates its own TemporaryDirectory and lets GC clean
    # it; that library-internal ResourceWarning is not an app defect. Filter is
    # message-scoped so every other ResourceWarning (e.g. our own leaked files)
    # still surfaces.
